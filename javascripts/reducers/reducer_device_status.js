...
import { WAITING_FOR_SBL, WAITING_FOR_APP_UPDATE, UPDATE_NOT_STARTED, UPDATE_READY, UPDATE_IN_PROGRESS } from '../utils/device_utils';
import { REQUEST_SBL_FOR_UPDATE } from '../actions/ftp_action';
import { REQUEST_REBOOT_AFTER_UPDATE } from  '../actions/get_device_data';

export default function(state = {app_status: NO_DEVICE_STATUS, update_status: UPDATE_NOT_STARTED }, action){
  let result = {};
  switch (action.type){
